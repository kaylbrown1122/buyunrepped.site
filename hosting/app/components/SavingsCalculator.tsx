...
export default function SavingsCalculator() {
  ...
  return (
    <div className="mt-5 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
      <label
        className="text-[9px] font-bold uppercase tracking-[0.16em] text-gray-600"
      ...
      <div className="mt-2 flex items-baseline justify-between gap-2">
        <span className="text-[11px] text-gray-600">$250K</span>
        <span className="text-xl font-extrabold tabular-nums text-brand-navy sm:text-2xl">
          {formatPrice(price)}
        </span>
        <span className="text-[11px] text-gray-600">$3M</span>
      </div>
      <input
      ...
      <div className="mt-3 grid grid-cols-3 gap-2 sm:gap-3">
        <div className="rounded-xl bg-gray-50 px-2 py-2.5 sm:px-3">
          <p className="text-[8px] font-bold uppercase tracking-wide text-gray-600 sm:text-[9px]">
            Traditional
          </p>
          <p className="mt-0.5 text-base font-extrabold tabular-nums text-gray-700 sm:text-lg">
            ${traditional.toLocaleString()}
          </p>
          <p className="mt-0.5 text-[9px] leading-tight text-gray-600">~{pctLabel} illustration</p>
        </div>
        ...
        <div className="rounded-xl bg-brand-green/10 px-2 py-2.5 text-center sm:px-3">
          <p className="text-[8px] font-bold uppercase tracking-wide text-[#047857] sm:text-[9px]">
            Illustrative difference
          </p>
          <p className="mt-0.5 text-base font-extrabold tabular-nums text-[#047857] sm:text-lg">
            ${youKeep.toLocaleString()}
          </p>
          <p className="mt-0.5 text-[9px] leading-tight text-[#047857]">Illustration</p>
        </div>
      </div>

      <p className="mt-2.5 text-[9px] leading-snug text-gray-600">
