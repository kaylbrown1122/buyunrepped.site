...
const REFUND_CUTOFF =
  'Two limits apply without exception: the Offer Package fee becomes nonrefundable once your offer strategy call takes place, or once you waive or miss that call, because your broker prepares your offer strategy in advance of the scheduled call; and the Transaction Guidance fee becomes nonrefundable once your repair proposal has been sent. After either event, no refund of the corresponding fee will be issued for any reason.';
...
const pricingFaqs = [
  ...
  },
  {
    ...
    a: 'The standard Offer Package after launch is $995. It includes offer-preparation guidance using Tennessee residential forms, a strategy consultation, a comparative market analysis, and a broker price opinion (BPO). You decide the terms, approve the documents, and submit your own offer.',
  },
  {
    q: 'What does Transaction Guidance include?',
    a: 'The standard Transaction Guidance price after launch is $2,495. It includes full coordination from contract through closing, platform access with templates and self-guided assistance, and direct broker support when you need it most.',
  },
  {
    q: 'When is the Offer Package fee due? When is Transaction Guidance due?',
    a: `The standard Offer Package price after launch is $${OFFER_FEE}. It is due upfront when you start in the app. The standard Transaction Guidance price after launch is $${TRANSACTION_FEE_FULL.toLocaleString()} and is due when you upload your signed contract after acceptance. During launch, your active tier price applies at checkout.`,
  },
  {
  ...
  },
  {
    ...
    a: 'No. BuyUnrepped offers a single offer package at signup during launch tiers, with no free estimate or lite tier. The standard price after launch is $995.',
  },
  {
    q: 'What if I need to cancel, or want a refund?',
    a: `All fees are final once paid. If you need to cancel, email info@buyunrepped.com and we may issue a full or partial refund at our discretion. ${REFUND_CUTOFF} Rescheduling and other service fees are nonrefundable once the service has been performed.`,
  },
] as const;
        ...
        <section className="border-b border-gray-100 bg-white px-4 pb-12 pt-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-3 text-3xl font-extrabold tracking-tight text-brand-navy sm:text-4xl md:text-[2.5rem]">
              Offer Package and Transaction Guidance
            </h1>
          ...
          <div className="mx-auto mt-12 max-w-5xl">
            ...
            <div className="mt-14 text-center">
              <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-brand-blue">
                Standard / full price after launch
              </p>
            </div>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2 md:gap-8">
              ...
              <div id="transaction-guidance" className="scroll-mt-24 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
