  ...
  tiers: [
    {
      tier_number: 1,
      tier_name: 'Founding',
      offer_price_cents: 65000,
      transaction_price_cents: 87500,
      bundle_price_cents: 122500,
      status: 'active',
    },
    {
      tier_number: 2,
      tier_name: 'Level 2',
      offer_price_cents: 95000,
      transaction_price_cents: 137500,
      bundle_price_cents: 192500,
      status: 'draft',
    },
    {
      tier_number: 3,
      tier_name: 'Level 3',
      offer_price_cents: 115000,
      transaction_price_cents: 187500,
      bundle_price_cents: 262500,
      status: 'draft',
    },
    {
      tier_number: 4,
      tier_name: 'Standard',
      offer_price_cents: 149500,
      transaction_price_cents: 249500,
      bundle_price_cents: 349000,
      status: 'draft',
    },
  ],
